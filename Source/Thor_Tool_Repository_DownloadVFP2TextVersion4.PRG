...
If Pcount() = 1								;
	...
	With m.lxParam1
		...
		* Required
		.Prompt		   = 'Download VFP2Text for Beyond Compare v4' && used in menus

		Text To .Description Noshow
Download the installer for VFP2Text for Beyond Compare v4.
		Endtext
...
Procedure ToolCode
	...
	GoURL("http://pfsolutions-mi.com/Downloads/VFP2Text/VFP2Text-v4.exe")
Endproc
