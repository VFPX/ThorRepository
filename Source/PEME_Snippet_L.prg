...
<table border="1">
	...
	lcFormFileName = Execscript (_Screen.cThorDispatcher, 'Full Path=PEME_Internal_L.SCX')
	Do Form (lcFormFileName) With 'Layout for ' + lcFileName, lcHTMLHeader + lcResult, 300, 600
...
Function PublishHelp
	...
	Text To lcSummaryHTML Noshow Textmerge
		Shows the data structure for <u>Alias</u>.
	Endtext

	Text To lcDetailHTML Noshow Textmerge
		Opens a form showing the data structure of a table. <br><br>
